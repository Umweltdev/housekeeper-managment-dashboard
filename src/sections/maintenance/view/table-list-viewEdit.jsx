...
import InvoiceTableToolbar from './table-toolbar';
...
const TABLE_HEAD = [
  { id: 'itemName', label: 'Room/Area' },
  { id: 'issue', label: 'Issue' },
  { id: 'requestDate', label: 'Date Reported' },
  { id: 'requestedBy', label: 'Assigned' },
...
export default function InvoiceListViewEdit() {
  ...
  const TABS = [
    ...
    },
    {
      ...
      label: 'Blocked',
      color: 'error',
      count: getInvoiceLength('Blocked'),
    },
    // {
    //   value: 'Received',
    //   label: 'Out of Stock',
